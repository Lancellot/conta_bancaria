...
export class ContaController implements ContaRepository {
    ...
    public sacar(numero: number, valor: number): void {
        try {
            ...
            console.log(colors.fg.red, `\nErro ao sacar: ${(erro as Error).message}`, colors.reset);
        }
    }
    ...
    public depositar(numero: number, valor: number): void {
        try {
            ...
            console.log(colors.fg.red, `\nErro ao Depositar: ${(erro as Error).message}`, colors.reset);
        }
    }
    ...
    public transferir(numeroOrigem: number, numeroDestino: number, valor: number): void {
        try {
            ...
            console.log(colors.fg.red, `\nErro ao transferir: ${(erro as Error).message}`, colors.reset);
        }
    }
